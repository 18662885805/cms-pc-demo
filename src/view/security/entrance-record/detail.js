...
import { entryDetail,orgEntryDetail,allEntryDetail} from '@apis/security/entryrecord'
import GoBackButton from '@component/go-back'
import CommonUtil from '@utils/common'
import CardDetail from '@component/CardDetail'
import moment from 'moment'
import intl from "react-intl-universal";
import { allEntry } from '../../../apis/security/entryrecord'
...
class RecordDetail extends React.Component {
    ...
    componentDidMount() {
        ...
        if (this.props.location.state === undefined || this.props.location.state.id === undefined) {
          ...
          console.log('521',type)
          if(type == 1){
            entryDetail(project_id,{id: this.props.location.state.id}).then((res) => {
            ...
            allEntryDetail(project_id,{id: this.props.location.state.id}).then((res) => {
              const results = res.data;
              this.setState({
                  ...results,
              })

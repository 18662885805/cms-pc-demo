  ...
  constructor(props) {
    ...
    this.state = {
      column: [
          ...
          },
        {
          ...
          render: (text, record, index) => {
            ...
            let path = {
              pathname: "/task/task-resolve/detail",
              state: {
                status: status
              }
            };
            return (
              <Link to={path}>{'处理'}</Link>
            );
          }
        }
      ],
      ...
      selectedRowKeys: [],
        ...
        editData:{},
        mockData:[
          {id:1,title:'重要任务1',user:'Adolph',start_time:'2020-04-11',created:'jmy',created_time:'2020-04-01',status:2},
          {id:2,title:'重要任务2',user:'Adolph',start_time:'2020-04-12',created:'jmy',created_time:'2020-04-01',status:3},
          {id:4,title:'重要任务3',user:'Adolph',start_time:'2020-04-13',created:'jmy',created_time:'2020-04-01',status:4},

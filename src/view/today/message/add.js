...
import{messagePost} from "@apis/today/message";
...
class PushMessageAddForm extends React.Component {
    ...
    this.props.form.validateFields((err, values) => {
      ...
      if (!err) {
        ...
        confirm({
          ...
          cancelText: '取消',
          onOk() {
            messagePost(project_id,data).then((res) => {
  ...
  render() {
    ...
    const { confirmLoading, spinLoading, fileList, data, m_type } = this.state;
    const { formatMessage } = this.props.intl;

...
import { MeetingType, MeetingTypeDelete } from "@apis/meeting/type";
...
export default class extends React.Component {
  ...
  onDeleteOne = id => {
    ...
    const { formatMessage } = this.props.intl;
    MeetingTypeDelete(id, { project_id: _util.getStorage('project_id') }).then((res) => {
  ...
  render() {
    ...
    const bread = [
      ...
      {
        name: formatMessage({
          id: "page.menu.meeting.management",
          defaultMessage: "会议管理"
        })
      },
      {
        name: formatMessage({
          id: "page.menu.meeting.meetingtype",
          defaultMessage: "会议类型"
        }),
        url: "/meeting/type"
      }
      ...
      <div>
        ...
        <div className="content-wrapper">
          <TablePage
            ...
            getFn={MeetingType}
            columns={column}
            addPath={"/meeting/type/add"}
            excelName={check(this, "excel") && formatMessage({ id: "page.system.user.roleManagement", defaultMessage: "会议类型" })}
            dataMap={data => {

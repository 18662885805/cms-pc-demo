...
import {workTypePost, workTypePut, workTypeDetail} from "@apis/system/worktype";
...
class WorkTypeAddForm extends React.Component {
  ...
  componentDidMount() {
    ...
    if (id) {
      workTypeDetail(id, {project_id: _util.getStorage('project_id') }).then((res) => {

...
import {documentDirectoryPost} from "@apis/document/directory";
...
class DirectoryAddForm extends React.Component {
  ...
  handleSubmit (e) {
    ...
    this.props.form.validateFields((err, values) => {
      if (!err) {
        let _this = this;
        const {checked,reader_info_list} = this.state;
        var reader = _util.renderListToString(reader_info_list,'project_user_id');
        ...
        confirm({
          ...
          onOk () {
            ...
            documentDirectoryPost(project_id,postData).then((res) => {

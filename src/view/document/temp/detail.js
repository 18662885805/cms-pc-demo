...
import {TemporaryDocumentDetail} from "@apis/document/temp";
...
class DocumentDetail extends React.Component {
  ...
  componentDidMount() {
    if (this.props.location.state === undefined || this.props.location.state.id === undefined) {
      ...
      TemporaryDocumentDetail(project_id, {
        id:id,
        directory:directory
      }).then((res) => {
        this.setState({
  ...
  render() {
    ...
    const bread = [
      ...
      {
        name: '详情',
        url: '/document/temporary/document/detail'
      },
    ]

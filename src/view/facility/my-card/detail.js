...
import {MyMaintCardDetail} from "@apis/facility/mymaintcard"
...
class MaintCardDetail extends React.Component {
  constructor(props) {
    super(props)
    this.state = {
      name: '',
  ...
  componentDidMount() {
    if (this.props.location.state === undefined || this.props.location.state.id === undefined) {
      ...
      MyMaintCardDetail(this.props.location.state.id).then((res) => {
        ...
        this.props.menuState.changeMenuCurrentUrl('/eqp/mymaintcard')
  ...
  render() {
    const {
      ...
      end_date, created_name, created_time, updated_name, update_time, file_path, maintain_detail
    } = this.state
...
export default MaintCardDetail

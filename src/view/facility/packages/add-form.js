...
import {Form, Button, Modal, Input, Select, Switch, Spin, Icon, message,
  Upload, Checkbox, Cascader, TreeSelect, DatePicker} from 'antd'
import debounce from 'lodash/debounce'
import { FormattedMessage, injectIntl, defineMessages } from 'react-intl'
import moment from 'moment'
import CommonUtil from '@utils/common'
import MyBreadcrumb from '@component/bread-crumb'
import {PackagePost} from '@apis/facility/packages'
...
class PackageAddForm extends React.Component {
  ...
  fetchUser = (value) => {
    ...
    interviewee({q: value, type: 'event', project_id: _util.getStorage('project_id')}).then((res) => {
  ...
  render() {
    ...
    const {confirmLoading, formData, spinLoading, data} = this.state
    const { formatMessage } = this.props.intl

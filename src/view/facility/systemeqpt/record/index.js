...
import {EqptRecordList} from '@apis/facility/syseqpt'
...
export default class extends React.Component {
    ...
    this.state = {
      column: [
        ...
        },
        {
          ...
          render: (text, record, index) => {
            let path = {
              pathname: '/eqp/syseqp/record/detail',
              state: {
                id: record.id
              }
            }
        ...
        },
        {
          ...
          render: (text, record, index) => {
            return (
              record.next_date ? moment(record.next_date).format('YYYY-MM-DD') : '无'
            )
          }
        },
        {
          ...
          render: (text, record, index) => {
            return (
              record.submit_time ? moment(record.submit_time).format('YYYY-MM-DD') : '无'
            )
          }
        },
        {
          ...
          //     case 2:
          //       return (<Tag color="#2db7f5">异常</Tag>);
          //     case 3:
  ...
  getInfo(params) {
    ...
    EqptRecordList(params).then((res) => {

...
import { Template, TemplateDelete } from "@apis/workflow/template";
...
export default class extends React.Component {
      ...
      column: [
        ...
        },
        {
          ...
          render: (text, record, index) => {
            ...
            let path = `/workflow/template/add/${id}`;
  ...
  onDeleteOne(id) {
    ...
    const { formatMessage } = this.props.intl;
    TemplateDelete(id, {project_id: _util.getStorage('project_id') }).then((res) => {
      ...
      <div>
        ...
        <div className="content-wrapper">
          <TablePage
            ...
            getFn={Template}
            columns={column}
            addPath={canAdd&&"/workflow/template/add"}
            excelName={'表单配置'}
            dataMap={data => {

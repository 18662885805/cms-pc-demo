...
import { classification, classificationDelete } from "@apis/workflow/classification";
...
export default class extends React.Component {
      ...
      column: [
        {
          ...
          // render: (text, record) => {
          //   return <Link to={{
          //     pathname: "/workflow/classification/detail",
          //     state: {
          //       id: record.id
          //     }
          //   }} onClick={this.setScrollTop}>{_util.getOrNullList(record.abbreviation)}</Link>;
          // }
        },
        {
          title:'编号',    //职务名称
        ...
        },
        {
          ...
          dataIndex: "name",
          sorter: _util.sortString,
          render: record => _util.getOrNullList('是')
        },
        {
  ...
  render() {
    ...
    const bread = [
      ...
      {
        name: formatMessage({
          id: "page.component.workFlow.source",

  ...
  render() {
    ...
    return (
      <div>
        ...
        <div
          className="content-wrapper content-no-table-wrapper"
                  ...
                  <div className={styles.field}>
                    ...
                    <div className={styles.wrap} style={{ border: "none" }}>
                      ...
                      <ApprovalStep
                        ...
                        type={"record"}
                        is_begin_can_edit={
                          approval && approval.is_begin_can_edit
                        }
                      />
                    </div>
                  </div>
                              ...
                              return (
                                ...
                                >
                                  <td align="right" style={{ width: "8%" }}>
                                    <FormattedMessage
                                      id="page.construction.projectAudit.progress5"
                                      defaultMessage="审批人"
                                    />
                                    :
                                  </td>
                                  <td align="center" style={{ width: "20%" }}>
                                    {item.operation_name +
                                      " " +
                                      item.operation_phone}
                                  </td>
                                  {/*<td align="right" style={{ width: "8%" }}>审批人电话:</td>*/}
                                  {/*<td align="center" style={{ width: "15%" }}>{item.operation_phone}</td>*/}
                                  <td align="right" style={{ width: "8%" }}>
                                    <FormattedMessage
                                  ...
                                  <td align="center" style={{ width: "10%" }}>
                                    {_util.flowStatus(item.status)}
                                  </td>
                                  <td align="right" style={{ width: "8%" }}>
                                    <FormattedMessage
                                      id="page.construction.monitor.remark"
                                      defaultMessage="备注"
                                    />
                                    :
                                  </td>

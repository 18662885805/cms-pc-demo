...
import {
    ...
    Rate,
    message,
    Timeline, InputNumber, Tag, Switch, DatePicker
} from 'antd'
import {inject, observer} from "mobx-react/index"
import MyBreadcrumb from '@component/bread-crumb'
import {myOrderDetail, myOrderHandlePost,contactSearch} from "@apis/workorder/my-order"
import {recordDetail,recordHandle,recordPdf} from '@apis/workorder/order'
import {waitDetail} from '@apis/workorder/wait'
...
class MyOrderDetailForm extends React.Component {
    ...
    componentWillMount() {
        ...
        if (this.props.location.state === undefined || this.props.location.state.id === undefined) {
            ...
            waitDetail(this.props.location.state.id,{project_id:_util.getStorage('project_id')}).then((res) => {
                console.log(res);
                let data = res.data;
                ...
                this.setState({flowsObj:flowsObj})
                ...
                this.props.menuState.changeMenuCurrentUrl('/assignment/wait')
                                    ...
                                    return (<Timeline.Item key={flowIndex} color={'blue'}>
                                            <div className={''}>
                                                ...
                                                {flow.fields.pic_source ?
                                                    <Upload fileList={flow.flow_source} listType={'picture-card'} showUploadList={{showRemoveIcon:false,showDownloadIcon:false}}/>
                                                : null}
                                                {/*</div>*/}
                            ...
                            <Form>
                                {[2,8,10].indexOf(this.state.l_action)>-1 ?
                                    <div>
                                        ...
                                        <FormItem {...formModalLayout} style={{marginBottom:'8px'}} label={<FormattedMessage id="page.order.myOrder.sendTo" defaultMessage="派发给"/>} required>
